    ...
    copy: {
      common: {
        files: [
          ...
          { expand: true, cwd: '.', src: ['app/lib/q/q.js'], dest: 'build/' },
          { expand: true, cwd: '.', src: ['app/lib/pegjs/peg-0.10.0.min.js'], dest: 'build/' },
          { expand: true, cwd: '.', src: ['app/lib/iscroll/build/iscroll.js'], dest: 'build/' },
          { expand: true, cwd: '.', src: ['app/lib/open-sans/fonts/light/opensans-light-webfont.ttf'], dest: 'build/' },
          { expand: true, cwd: '.', src: ['app/lib/open-sans/fonts/regular/opensans-regular-webfont.ttf'], dest: 'build/' },
          { expand: true, cwd: '.', src: ['app/lib/open-sans/fonts/semibold/opensans-semibold-webfont.ttf'], dest: 'build/' },
